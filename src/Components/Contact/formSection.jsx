    ...
    <>
      <div className="relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <form
            className="relative z-5 grid grid-cols-2"
            onSubmit={handleSubmit}
          >
            {/* Row 1: Name / Email */}
            <div className="p-6 ">
              <label className="block text-sm font-semibold mb-2 text-[#F6BC6D]">
                Nice to meet you
              </label>
              <input
                type="text"
                ...
                className="w-full border-none outline-none py-2 pl-2 rounded-md bg-[#0e1c41] placeholder-gray-400 focus:font-semibold text-xs lg:text-lg"
                required
              />
            </div>
            <div className="p-6 ">
